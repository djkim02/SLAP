...
/**
 * Created by kylemn on 11/16/15.
 */

public class MessageService extends Service implements SinchClientListener {
    private static final String APP_KEY = "1392a2ec-993e-4d7e-93ab-b29f5063fe31";
    private static final String APP_SECRET = "Psok3W8u6ES5Qc2xd/SMxg==";
    ...
    public void startSinchClient(String username) {
        ...
        sinchClient.registerPushNotificationData("674554739144".getBytes());
